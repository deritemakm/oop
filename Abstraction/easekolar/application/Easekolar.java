...
public class Easekolar extends JFrame {
    ...
    private Border roundedBorder = new LineBorder(clrDarkPink, 2, true);
    ...
    public void makeHeader() {
        ...
        JLabel lblHeaderTitle = new JLabel("Home");
        lblHeaderTitle.setForeground(Color.BLACK);
        lblHeaderTitle.setFont(new Font("Arial", Font.BOLD, 30));
    ...
    public void makeSidebar() {
        ...
        for (int i = 0; i < arrSubjectButtons.length; i++) {
            ...
            arrSubjectButtons[i].setBorder(roundedBorder);
            arrSubjectButtons[i].setBackground(clrLightPink);
            arrSubjectButtons[i].setForeground(Color.BLACK);
            arrSubjectButtons[i].setFont(new Font("Arial", Font.PLAIN, 14));
            arrSubjectButtons[i].addActionListener(new SidebarListener(this));
            arrSubjectButtons[i].addMouseListener(new HoverListener());
            arrSubjectButtons[i].setPreferredSize(new Dimension(230, 40));
    ...
    public void makeButtonPanel() {
        ...
        btnAddTask.setBorder(roundedBorder);
        btnAddTask.setBackground(clrDarkPink);
        btnAddTask.setForeground(Color.BLACK);
        btnAddTask.setPreferredSize(new Dimension(getWidth(), 40));
        ...
        btnAddTask.setFont(new Font("Arial", Font.PLAIN, 16));
    }
    ...
    public void setHeaderText(String headerText) {
        JLabel lblHeaderTitle = new JLabel(headerText);
        lblHeaderTitle.setForeground(Color.BLACK);
